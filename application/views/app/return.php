...
<div class="about-box">
    ...
    <div class="about-img1">
        <img src="/static/admin/images/s.png" alt="">
    </div>
    <div class="about-img2">
        <img src="/static/admin/images/styllist1.png" alt="">
    </div>
    <div class="about-img3">
        <a href="">
            <img src="/static/admin/images/apple.png" alt="">
        </a>
    </div>
    <div class="about-content1">
        <div class="about-contenttop">
            <img src="/static/admin/images/about1.png" alt="">
        </div>
        <h2></h2>
