...
<div class="m-center-right" style="float:left;padding-bottom:30px">
    <div class="count-box">
        <?php $this->load->view('admin/stat/nav',array('nav_current'=>'collection'));?>
        <!-- 表单部分内容 -->
...
<script>
    ...
    $(document).ready(function () {
        var g_source_url = CONFIG.collection.list_url + "?rt=json&userid=<?=$responsible_userid?>";
...
//            "serverSide": true,   //@todo 多的时候需要实现翻页
            ...
            "columns": [
                {"data": "id", 'title': 'id'},
                {"data": null, 'title': '描述', className: "collection-desc-td dt-head-center",width:"200px",},
...
//username add link
                {
                    'render': function (data, type, row) {
                        ...
                        str += '<a href="' + CONFIG.collection.preview_url + '?collection_id=' + data.id + '"  target="_blank" class="btn btn-link">';
