...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Image Cropper</title>
        ...
        <link href="assets/plugins/image-cropper/css/cropper.css" rel="stylesheet" type="text/css" media="screen"/><link href="assets/plugins/image-cropper/css/docs.css" rel="stylesheet" type="text/css" media="screen"/>        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
    ...
    <body class=" "><!-- START TOPBAR -->
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Image Cropper</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-8">
                                            <div>
                                                <img class="cropper" src="data/image-cropper-1.jpg" alt="Picture">
                                            </div>
                                        ...
                                        <div class=" eg-input">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="getData" >Get Data</span>
                                                    <input class="form-control" id="showData" type="text">
                                                    <span class="input-group-addon" id="getData2">Get Data (Rounded)</span>
                                                </div>

                                                <div class="input-group">
                                                    <span class="input-group-addon" id="getImageData">Get Image Data</span>
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="replace" >Replace</span>
                                                    <input class="form-control" id="replaceWith" type="text" value="data/image-cropper-2.jpg">
                                                </div>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="setAspectRatio" >Set Aspect Ratio</span>
                                                    <input class="form-control" id="aspectRatio" type="text" value="auto">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="zoom">Zoom</span>
                                                    <input class="form-control" id="zoomWith" type="number" value="0.5">
                                                </div>
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="rotate">Rotate</span>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="assets/plugins/image-cropper/js/cropper.js" type="text/javascript"></script><script src="assets/plugins/image-cropper/js/docs.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
