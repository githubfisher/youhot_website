...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Modals</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-modals.html">Modals</a>
                                </li>
                                <li>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Modals</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <h4>Basic Dialogs</h4>
                                            <br>
                                            <a class="btn btn-success btn-block" data-toggle="modal" href="#ultraModal-1">Dialog</a><br>
                                            <a class="btn btn-warning btn-block" data-toggle="modal" href="#ultraModal-2">Confirm</a><br>
                                            <a class="btn btn-danger btn-block" data-toggle="modal" href="#ultraModal-3">Alert !</a><br>
                                            <a data-toggle="modal" href="#ultraModal-4" class="btn btn-info btn-block">Confirm to Close</a><br>
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <h4>Responsive & Custom Width</h4>
                                            <br>
                                            <a data-toggle="modal" href="#ultraModal-5" class="btn btn-primary btn-block">Custom Width</a><br>
                                            <a data-toggle="modal" href="#ultraModal-6" class="btn btn-primary btn-block">Full Width</a><br>
                                            <a data-toggle="modal" href="#ultraModal-7" class="btn btn-primary btn-block">Responsive Modal</a><br>
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <h4>AJAX</h4>
                                            <br>
                                            <a data-toggle="modal" onclick="AjaxModalContent();" class="btn btn-purple btn-block">AJAX Modal</a>
                                            <br>					
                                        </div>
                                        ...
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-6"  tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Animated Modals</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-10">Fade Down</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-11">Fade Up</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-12">Fade Left</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-13">Fade Right</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-14">Bounce Down</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-15">Bounce Up</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-16">Bounce Left</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-17">Bounce Right</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-18">Rotate Down Left</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-19">Rotate Down Right</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-20">Rotate Up Left</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-21">Rotate Up Right</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-22">Zoom Down</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-23">Zoom Up</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-24">Zoom Left</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-25">Zoom Right</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-26">Flip</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-27">Zoom</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-28">Swing</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-29">Shake</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-30">Flip X</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-31">Flip Y</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-32">Rubber Band</a><br></div>


                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6"><a class="btn btn-purple btn-block" data-toggle="modal" href="#ultraModal-33">Light Speed</a><br></div>
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-11" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-12" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-13" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-14" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-15" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-16" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-17" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-18" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-19" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-20" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-21" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-22" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-23" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-24" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-25" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-26" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-27" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-28" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-29" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-30" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-31" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-32" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                        ...
                                        <!-- modal end -->
                                        <!-- modal start -->
                                        <div class="modal fade" id="ultraModal-33" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
