...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Progress Bar</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-progress.html">Progress Bars</a>
                                </li>
                                <li>
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Progress Bar</h1>                            </div>
                    ...
                    <div class="col-lg-6">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Sizes</h2>
                    ...
                    <div class="col-lg-6">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Colors & Contextual</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-orange" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">
                                                Orange
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Loading Animations (Duration & Delay)</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="progress">
                                                    <div class="progress-bar animated fadeIn animated-duration-1s animated-delay-200ms" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%;">
                                                        Fade In
                                                    </div>
                                                </div>

                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-success animated bounceInLeft animated-duration-1s animated-delay-400ms" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
                                                        Bounce In Left
                                                    </div>
                                                </div>

                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-info animated flipInY animated-duration-1s animated-delay-600ms" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%;">
                                                        Flip
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-warning animated rotateInUpLeft animated-duration-1s animated-delay-800ms" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                                                        Rotate Up
                                                    </div>
                                                </div>

                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-danger animated rotateInDownLeft animated-duration-1s animated-delay-1000ms" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%;">
                                                        Rotate Down
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar animated slideInLeft animated-duration-1s animated-delay-1400ms" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%;">
                                                        Slide In Left
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-success animated lightSpeedIn animated-duration-1s animated-delay-1600ms" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
                                                        Light Speed In
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-info animated zoomIn animated-duration-1s animated-delay-1800ms" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%;">
                                                        Zoom In
                                                    </div>
                                                </div>

                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-warning animated zoomInLeft animated-duration-1s animated-delay-2000ms" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                                                        Zoom In Left
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-danger animated rollIn animated-duration-1s animated-delay-2200ms" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;">
                                                        Roll In
                                                    </div>
                                                </div>
                    ...
                    <div class="col-lg-6">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Stripped</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-6">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Constantly Animated</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Stacked</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
