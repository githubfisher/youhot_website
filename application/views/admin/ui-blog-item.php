...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Single Blog Post</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-blogs.html">Blogs</a>
                                </li>
                                <li>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="blog_post full_blog_post">
                                            <h3><a href="ui-blog-item.html">Contrast and Similarity in Graphic Design</a></h3>
                                            ...
                                            <div class="blog-content">
                                                ...
                                                <img class="media-object" src="data/blog.png" alt="">
