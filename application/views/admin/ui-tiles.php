...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Tile Widgets</title>
        ...
        <link href="assets/plugins/jquery-ui/smoothness/jquery-ui.min.css" rel="stylesheet" type="text/css" media="screen"/>        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
    ...
    <body class=" "><!-- START TOPBAR -->
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-tiles.html">Tile Widgets</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Tile Widgets</h1>                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Counter Tiles</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div class="tile-counter inverted text-orange">
                                            <div class="content">
                                                <i class='fa fa-user icon-lg'></i>
                                                <h2 class="number_counter" data-speed="3000" data-from="1001" data-to="3304">1001</h2>
                                                <div class="clearfix"></div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Progress Bar Tiles</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress bg-purple">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress bg-orange">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-primary">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-purple">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-orange">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-warning">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-info">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-success">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-danger">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="tile-progress inverted text-secondary">
                                            <div class="content">
                                                <h4><i class='fa fa-dashboard icon-sm'></i> Server Load</h4>
                                                <div class="progress"><div class="progress-bar inviewport animated" data-vp-add-class="visible slideInLeft" data-vp-repeat="true" data-vp-offset="100" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div></div>
                                                <span>40% increase</span>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="assets/plugins/count-to/countto.js" type="text/javascript"></script> <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
