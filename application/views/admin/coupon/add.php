...
<div class="m-center-right">
    <div class="m-center-top">
        <div class="col-sm-4"><h3>添加优惠券</h3></div>
	<div class="col-sm-8">
	    <h3 class="text-right">
        ...
        <section class="wrapper" style='width:100%;'>
            <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                        <input type="text" placeholder="名称（目前仅用于后台区分各个优惠券）" style="" class="form-control" name="name"
			    ...
			    <!--商品名称一栏-->
                            <div class="form-group">
                                <div class="controls">
                                    <label class="control-label col-sm-2 col-md-2 col-xs-12 require" for="field-1">规则说明</label>
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                          <textarea placeholder="规则说明：优惠券规则说明。" class="form-control" id="description"></textarea> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                        <input type="text" placeholder="优惠券面额限定：100" style="" class="form-control" name="value"
                                               id="value" value="" required>
                                    </div>
                                </div>
                            </div>
			    ...
			    <div class="form-group">
                                <div class="controls">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                        <input type="text" placeholder="最低消费限定：1000" style="" class="form-control" name="limit"
                                               id="limit" value="" required>
                                    </div>
                                </div>
                            </div>
			    ...
			    <div class="form-group">
					...
					<input type="text" placeholder="<?php echo date('Y-m-d H:i:s', time()) ?>" style="" class="form-control" name="get_at"
                                               id="get_at" value="<?php echo date('Y-m-d', time()) ?>" required>
                                    </div>
                                </div>
                            </div>
			   <div class="form-group">
					...
					<input type="text" placeholder="<?php echo date('Y-m-d H:i:s', time()+604800) ?>" style="" class="form-control" name="get_end"
                                               id="get_end" value="<?php echo date('Y-m-d', time()+604800) ?>" required>
                                    </div>
                                </div>
                            </div>
			    <div class="form-group">
					...
					<input type="text" placeholder="<?php echo date('Y-m-d H:i:s', time()) ?>" style="" class="form-control" name="use_at"
                                               id="use_at" value="<?php echo date('Y-m-d', time()) ?>" required>
                                    </div>
                                </div>
                            </div>
			    <div class="form-group">
					...
					<input type="text" placeholder="<?php echo date('Y-m-d H:i:s', time()+604800) ?>" style="" class="form-control" name="use_end"
                                               id="use_end" value="<?php echo date('Y-m-d', time()+604800) ?>" required>
                                    </div>
                                </div>
                            </div>
			    ...
			    <div class="form-group clearfix">
                            ...
                            <div class="form-group clearfix">
                                <div class="controls">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-xs-8">
                                        <textarea id="mobile_limit" class="form-control" rows="10" placeholder="请输入限定手机号码，以英文逗号','间隔；不限定请留空！"></textarea>
                                    </div>
			   ...
			   <div class="form-group clearfix">
			    ...
			    <div class="form-group">
                                <div class="controls">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                        <input type="text" placeholder="活动开始时间: <?php echo date('Y-m-d H:i:s', time()) ?>" style="" class="form-control" name="get_at"
                           ...
                           <div class="form-group">
                                <div class="controls">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                        <input type="text" placeholder="活动结束时间: <?php echo date('Y-m-d H:i:s', time()+604800) ?>" style="" class="form-control" name="get_end"
			    ...
			    <div class="form-group">
                                <div class="controls">
                                    ...
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                        <input type="text" placeholder="推荐几个人注册后得到一张券? 3个?" style="" class="form-control" name="value"
                                               id="reg_min" value="" required>
                                    </div>
                                </div>
                            </div>
...
<script>
	...
	var reg_at = $("#reg_at").val();
        ...
        var url = '/admin/coupon/add';
        $.post(url,{description,type,name,value,limit,store,category,get_at,get_end,use_at,use_end,is_exclusive,time_limit,get_limit,mobile_limit,reg_at,reg_end,reg_min,repeat,get_cid},function (data) {
            if (data.res == 0) {
                showSuccess();
            } else {
