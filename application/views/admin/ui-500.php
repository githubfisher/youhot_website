...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : 500 Error Page</title>
            ...
            <section class="box nobox">
                <div class="content-body">    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <h1 class="page_error_info">Oops! How did we end up here?</h1>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-8 col-md-offset-3 col-sm-offset-3 col-xs-offset-2">
                                <form action="javascript:;" method="post" class="page_error_search">
                                    ...
                                    <div class="text-center page_error_btn">
                                        <a class="btn btn-purple btn-lg" href='#'><i class='fa fa-location-arrow'></i> &nbsp; Back to Home</a>
                                    </div>
                                </form>
                            </div>
