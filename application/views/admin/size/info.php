        ...
        <div class="upload-info">
            ...
            <div class="col-sm-5">
                <h3 class="text-right">
                    ...
                    <label for="userfile" class="product-add btn btn-purple pull-left" onclick="userfile.click()" id="pick-img">
                        <input type="file" name="userfile" id="userfile" onchange="change();">
                        <?= $btn ?>
                    </label>
                    <label class="product-add btn btn-purple pull-left" for="sub" id="sub-label" onclick="exchange();">
