...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Gallery</title>
        ...
        <link href="assets/plugins/prettyphoto/prettyPhoto.css" rel="stylesheet" type="text/css" media="screen"/>        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
    ...
    <body class=" "><!-- START TOPBAR -->
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-gallery.html">Gallery</a>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Filterable Gallery</h2>
                                        ...
                                        <div id='portfolio' class="">
                                            <div class="text-center">
                                                <ul class="portfolio-filter list-inline">
                                                    <li><a class="btn btn-primary active" href="#" data-filter="*">All Works</a></li>
                                                    <li><a class="btn btn-primary " href="#" data-filter=".creative">Creative</a></li>
                                                    <li><a class="btn btn-primary " href="#" data-filter=".corporate">Corporate</a></li>
                                            ...
                                            <div class="portfolio-items">
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  creative">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/01.jpg" alt="">
                                                ...
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  corporate portfolio">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/02.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  creative">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/03.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  corporate">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/04.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  creative portfolio">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/05.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  corporate">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/06.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                            <h3>Portfolio Item 5</h3>
                                                            <span class='desc'>A brief description area for the portfolio item.</span>
                                                ...
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  creative portfolio">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/07.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-md-4 col-sm-6 col-xs-12  corporate">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-responsive" src="data/gallery/08.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="assets/plugins/prettyphoto/jquery.prettyPhoto.js" type="text/javascript"></script><script src="assets/plugins/isotope/jquery.isotope.min.js" type="text/javascript"></script><script src="assets/plugins/isotope/jquery.isotope.sloppy-masonry.min.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
