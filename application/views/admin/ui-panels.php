...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Draggable Panels</title>
    ...
    <body class=" "><!-- START TOPBAR -->
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-panels.html">Draggable Panels</a>
                                </li>
                                <li>
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Draggable Panels</h1>                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Default Panel</h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box primary">
                            <header class="panel_header">
                                <h2 class="title pull-left">Primary Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box purple">
                            <header class="panel_header">
                                <h2 class="title pull-left">Purple Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box orange">
                            <header class="panel_header">
                                <h2 class="title pull-left">Orange Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box success">
                            <header class="panel_header">
                                <h2 class="title pull-left">Success Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box warning">
                            <header class="panel_header">
                                <h2 class="title pull-left">Warning Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box info">
                            <header class="panel_header">
                                <h2 class="title pull-left">Info Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box danger">
                            <header class="panel_header">
                                <h2 class="title pull-left">Danger Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box transparent">
                            <header class="panel_header">
                                <h2 class="title pull-left">Transparent Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 sort_panel">
                        <section class="box inverted">
                            <header class="panel_header">
                                <h2 class="title pull-left">Inverted Panel</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="assets/plugins/jquery-ui/smoothness/jquery-ui.min.js" type="text/javascript"></script> <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
