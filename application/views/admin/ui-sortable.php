...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Sortable List</title>
        ...
        <link href="assets/plugins/uikit/css/uikit.min.css" rel="stylesheet" type="text/css" media="screen"/><link href="assets/plugins/uikit/css/components/nestable.min.css" rel="stylesheet" type="text/css" media="screen"/>        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-sortable.html">Sortable Group</a>
                                </li>
                                <li>
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Sortable List</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Sortable (Nestable) List</h2>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8 col-md-8 col-xs-12">
                                                ...
                                                <ul id="nestableList-1" class="uk-nestable" data-uk-nestable>
                                                    ...
                                                    <li data-item="Item 2" data-item-id="2">
                                                        ...
                                                        <ul>					
                                                            <li data-item="Item 7" data-item-id="7">
                                                                <div class="uk-nestable-item">
                                                                    <div class="uk-nestable-handle"></div>
                                                                    <div data-nestable-action="toggle"></div>
                                                                ...
                                                                <ul>					
                                                                    <li data-item="Item 8" data-item-id="8">
                                                                        <div class="uk-nestable-item">
                                                                            <div class="uk-nestable-handle"></div>
                                                                            <div data-nestable-action="toggle"></div>
                                                    ...
                                                    <li data-item="Item 3" data-item-id="3">
                                                        <div class="uk-nestable-item">
                                                            <div class="uk-nestable-handle"></div>
                                                            <div data-nestable-action="toggle"></div>
                                                    ...
                                                    <li data-item="Item 4" data-item-id="4">
                                                        <div class="uk-nestable-item">
                                                            <div class="uk-nestable-handle"></div>
                                                            <div data-nestable-action="toggle"></div>
                                                    ...
                                                    <li data-item="Item 5" data-item-id="5">
                                                        <div class="uk-nestable-item">
                                                            <div class="uk-nestable-handle"></div>
                                                            <div data-nestable-action="toggle"></div>
                                                    ...
                                                    <li data-item="Item 6" data-item-id="6">
                                                        <div class="uk-nestable-item">
                                                            <div class="uk-nestable-handle"></div>
                                                            <div data-nestable-action="toggle"></div>
                                            ...
                                            <div class="col-sm-4 col-md-4 col-xs-12">
                                                <textarea id="nestableList-1-ev" class="form-control" rows="17" placeholder="Nestable Events"></textarea>
                                            </div>
                                        </div>
