...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Members</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-members.html">Members</a>
                                </li>
                                <li>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-4">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-responsive" src="data/members/person-1.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Bin Lodi</h3>
                                                    ...
                                                    <ul class="social-icons list-inline list-unstyled">
                                                        <li><a href="#"><i class="fa fa-facebook icon-bordered icon-primary icon-xs"></i></a></li>
                                                        <li><a href="#"><i class="fa fa-twitter icon-bordered icon-primary icon-xs"></i></a></li>
                                                        <li><a href="#"><i class="fa fa-google-plus icon-bordered icon-primary icon-xs"></i></a></li>
                                                        <li><a href="#"><i class="fa fa-linkedin icon-bordered icon-primary icon-xs"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-4">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-responsive" src="data/members/person-2.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-responsive" src="data/members/person-3.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-md-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-responsive" src="data/members/person-4.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>I. Torkelson</h3>
                                            ...
                                            <div class="col-sm-4 col-md-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-responsive" src="data/members/person-5.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Melva Latshaw</h3>
                                            ...
                                            <div class="col-sm-4 col-md-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-responsive" src="data/members/person-6.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Clay Peskin</h3>
                                                        <span>Designer</span>
                                            ...
                                            <div class="col-sm-4 col-md-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-responsive" src="data/members/person-7.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Winford K.</h3>
                                                        <span>UI/UX</span>
