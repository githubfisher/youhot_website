...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Flot Charts</title>
    ...
    <body class=" "><!-- START TOPBAR -->
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="charts-flot.html">Flot Charts</a>
                                </li>
                                <li>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="assets/plugins/flot-chart/jquery.flot.js" type="text/javascript"></script><script src="assets/plugins/flot-chart/jquery.flot.fillbetween.js" type="text/javascript"></script><script src="assets/plugins/flot-chart/jquery.flot.navigate.js" type="text/javascript"></script><script src="assets/plugins/flot-chart/jquery.flot.pie.js" type="text/javascript"></script><script src="assets/plugins/flot-chart/jquery.flot.stack.js" type="text/javascript"></script><script src="assets/plugins/flot-chart/jquery.flot.crosshair.js" type="text/javascript"></script><script src="assets/plugins/flot-chart/jquery.flot.time.js" type="text/javascript"></script><script src="assets/plugins/flot-chart/jquery.flot.selection.js" type="text/javascript"></script><script src="assets/js/chart-flot.js" type="text/javascript"></script><script src="assets/plugins/icheck/icheck.min.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
