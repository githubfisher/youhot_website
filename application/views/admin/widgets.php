            ...
            <section id="main-content" class=" ">
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="wid-weather">
                                            ...
                                            <div class="today col-md-8 col-sm-8 col-xs-12 bg-primary">
                                            ...
                                            <div class="weekdays col-md-4 col-sm-4 col-xs-12 bg-white">
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">To Do Task Widget</h2>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Social Media Widgets</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="wid-blog">
                                            ...
                                            <div class="bg-primary wid-blog-title">
                                                <h2>Ultra Admin is a beautiful theme with tons of features</h2>
