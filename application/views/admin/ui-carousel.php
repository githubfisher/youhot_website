...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Carousel Slider</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-carousel.html">Carousel Slider</a>
                                </li>
                                <li>
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Carousel Slider</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Basic Carousel</h2>
                                        ...
                                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="item active">
                                                    <img src="data/carousel/v1.jpg" style="width:100%;">
                                                </div>
                                                <div class="item">
                                                    <img src="data/carousel/v2.jpg" style="width:100%;">
                                                </div>
                                                <div class="item">
                                                    <img src="data/carousel/v3.jpg" style="width:100%;">
                                                </div>    
                                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">With Captions</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="item active">
                                                    ...
                                                    <div class="carousel-caption">
                                                        <h3>First Slide</h3>
                                                        <div class="clearfix"></div>
                                                        <p>Carousels require the use of an id on the outermost container</p>
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <img src="data/carousel/v2.jpg" style="width:100%;">
