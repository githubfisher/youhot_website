...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : Chat Open Layout</title>
    ...
    <!-- BEGIN BODY -->
    <body class=" chat-open"><!-- START TOPBAR -->
        ...
        <div class="page-container row-fluid">
            ...
            <!-- SIDEBAR - START -->
            <div class="page-sidebar  chat_shift ">
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="layout-chat.html">Chat Open</a>
                                </li>
                                <li>
            ...
            <!--  SIDEBAR - END -->
            <!-- START CONTENT -->
            <section id="main-content" class=" chat_shift  ">
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Chat Open Layout</h1>                            </div>
