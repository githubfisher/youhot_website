<?php
class Jssdk {
  const APPID = 'wx0754694bbf52b837';
  const SECRET = '3ba0620406ae83334e83aefa621a1f54';
  ...
  public function getSignPackage() {
    ...
    $rt = $this->get_post('rt');
    if ($rt == 'jsonp') {
	$callback = $this->get_post('callback');
        exit($callback."(".json_encode($signPackage).");");
    } else {
        exit(json_encode($signPackage));
    }
  }

  private function get_post($name, $default='')
  {
