...
class upmp_config
{
    ...
    static $mer_id     				= "898111148990220"; // 商户号
    static $security_key    		= "ac4N8AXbEFbrBEbAFF7LIr08IbuHhbuI"; // 商户密钥
    static $mer_back_end_url     	= "http://www.aifudao.com/accounts/upmp_return"; // 后台通知地址
    static $mer_front_end_url     	= "http://www.aifudao.com/accounts/upmp_return"; // 前台通知地址
