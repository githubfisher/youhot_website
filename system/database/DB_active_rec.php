...
class CI_DB_active_record extends CI_DB_driver {
	...
	function count_all_results($table = '')
	{
		...
		if ($query === false or $query->num_rows() == 0)
		{
			return 0;
		}
	...
	function _reset_select()
	{
		$ar_reset_items = array(
								...
								'ar_offset'			=> FALSE,
								'ar_order'			=> FALSE,
                                '_protect_identifiers'=>TRUE,  //_protect_identifiers 重置，以免影响后面内容，add by mbo。又hack了一下，有时间参考这个把database也扩展了https://github.com/bcit-ci/CodeIgniter/wiki/Extending-Database-Drivers
							);
